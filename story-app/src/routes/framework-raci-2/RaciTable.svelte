<script lang="ts">
  ...
  let { title, rows }: { title: string; rows: RaciRow[] } = $props();
  ...
  <table class="rt-table">
    <thead>
      <tr>
        ...
        <th class="rt-th rt-th-role">R</th>
        <th class="rt-th rt-th-role">A</th>
        <th class="rt-th rt-th-role">C</th>
        <th class="rt-th rt-th-role">I</th>
      </tr>
    </thead>
    <tbody>
      {#each data as row}
